<script>
  ...
  <main>
   ...
   <body>
    ...
    <div class="">
        ...
        include name, age, job/position, and description
    ...
    <div class="desc">Morgan has collected ants since they were six years old and 
        now has many dozen ants but none in their pants.</div>
        */
    -->
    <div class="social-buttons">
        <!--<button><i class="material-icons">camera</i></button>
        <button><i class="material-icons">photo_camera</i></button>
        <button><i class="material-icons">music_note</i></button>-->
      </div>
      <div class="text">
        <div class="name-wrapper">
          <div class="name">Monkey, Monkey Years</div><i class="material-icons">check_circle</i>
        </div>
        <div class="title">Banana Collector</div>
      </div>
      <button class="like">
        <div class="hexagon"><i class="material-icons">favorite</i></div>
      </button>
    </div>
    <div class="bottom">
  ...
  <style>
    ...
    body {
        ...
        background: linear-gradient(150deg, #C52184, #A5C4D4);
...
.card .top {
  ...
  background-image: linear-gradient(-45deg, #fffff9, #d3d3d3);
  position: relative;
  width: 300px;
  height: 360px;
}
